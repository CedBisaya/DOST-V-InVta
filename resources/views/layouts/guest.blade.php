...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-poppins text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col justify-start items-center bg-gray-100 px-4 sm:px-0 pt-20">
            ...
            <div class="mt-16 w-full max-w-md sm:max-w-lg md:max-w-xl bg-white shadow-lg rounded-lg p-8 sm:p-10 flex flex-col justify-between">
                {{ $slot }}
            </div>

            <!-- Footer below the box -->
            <p class="text-center text-xs text-black-400 mt-6 sm:mt-10">
