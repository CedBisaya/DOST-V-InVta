        ...
        <div class="py-8 md:py-10">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-10 w-full px-6 md:px-8 lg:px-10">
                <div>
                    ...
                    <p class="text-cyan-500 font-medium text-sm mt-1">View the details of each user's activity logs</p>
                </div>  
                            ...
                            <tr>
                                <td colspan="5" class="px-8 py-20 text-center">
                                    <div class="flex flex-col items-center justify-center space-y-4">
                                        ...
                                        <div>
                                            <p class="text-gray-500 font-black text-sm uppercase tracking-widest">No Data found</p>
