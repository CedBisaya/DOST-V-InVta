    ...
    <table class="w-full text-left min-w-[600px]">
        <thead>
            <tr class="text-white bg-dost-cyan">
                <th class="px-6 py-4 font-bold text-sm rounded-l-xl">Event Name</th>
                <th class="px-6 py-4 font-bold text-sm">Date</th>
                <th class="px-6 py-4 font-bold text-sm">Event Manager</th>
                <th class="px-6 py-4 font-bold text-sm text-center">Venue</th>
