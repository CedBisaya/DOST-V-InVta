...
<div class="max-w-5xl mx-auto pb-10 px-4">
    ...
    {{-- Main Card --}}
    <div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-8 mb-6">
        ...
        <form action="#" method="POST" class="space-y-8">
            ...
            <div class="flex justify-end items-center space-x-4 mt-8 pt-6 border-t border-gray-50">
                <a href="#" class="text-gray-400 hover:text-gray-600 font-bold text-xs uppercase tracking-widest transition-colors">
                    Cancel
                </a>
